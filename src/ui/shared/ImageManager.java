...
public class ImageManager {
  ...
  private void initIconMap() {
    ...
    iconMapping.put(Constants.ICON_NETWORK_KEY, getSafeImageFromFile("icons/network_icon_32.png"));
    iconMapping.put(Constants.ICON_STAT_KEY, getSafeImageFromFile("icons/pie_chart_32.png"));
  }
