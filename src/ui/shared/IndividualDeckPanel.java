...
public class IndividualDeckPanel extends UIPanelBase {
  ...
  protected void initVariables() {
    ...
    selectedDescriptionField.setLineWrap(true);
    selectedDescriptionField.setWrapStyleWord(true);
  ...
  // Sets Editablity On Mass
  public void setEditablity (boolean editable) {
    selectedCreatedField.setEditable(editable);
    selectedDeckNameField.setEditable(editable);
    selectedDescriptionField.setEditable(editable);
    selectedFormatField.setEnabled(editable);
  }
